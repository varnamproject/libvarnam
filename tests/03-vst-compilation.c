...
int create_without_buffering()
{
    ...
    rc = varnam_create_token(handle, "pattern", "value1", "value2", "value3", "tag", VARNAM_TOKEN_VOWEL, VARNAM_MATCH_EXACT, 0);
    if (rc != VARNAM_SUCCESS)
    {
        printf("VARNAM_SUCCESS expected. Never got. %s", varnam_get_last_error(handle));
        return 1;
...
int auto_create_dead_consonants()
{
    ...
    rc = varnam_create_token(handle, "~", "്", NULL, "tag", "",VARNAM_TOKEN_VIRAMA, VARNAM_MATCH_EXACT, 1);
    if (rc != VARNAM_SUCCESS)
    {
        printf("VARNAM_SUCCESS expected. Never got. %s", varnam_get_last_error(handle));
        return 1;
    ...
    rc = varnam_create_token(handle, "ka", "ക", NULL, "tag", "", VARNAM_TOKEN_CONSONANT, VARNAM_MATCH_EXACT, 1);
    if (rc != VARNAM_SUCCESS)
    {
        printf("VARNAM_SUCCESS expected. Never got. %s", varnam_get_last_error(handle));
        return 1;
    ...
    rc = varnam_create_token(handle, "p", "പ്", NULL, "tag", "value3", VARNAM_TOKEN_CONSONANT, VARNAM_MATCH_EXACT, 1);
    if (rc != VARNAM_SUCCESS)
    {
        printf("VARNAM_SUCCESS expected. Never got. %s", varnam_get_last_error(handle));
        return 1;
...
int create_with_buffering()
{
    ...
    rc = varnam_create_token(handle, "pattern", "value1", "value2", "", "value3", VARNAM_TOKEN_VOWEL, VARNAM_MATCH_EXACT, 1);
    if (rc != VARNAM_SUCCESS)
    {
        printf("VARNAM_SUCCESS expected. Never got. %s", varnam_get_last_error(handle));
        return 1;
...
int create_exact_match_duplicates()
{
    ...
    rc = varnam_create_token(handle, "pattern", "value1", "value2", "", "value3", VARNAM_TOKEN_VOWEL, VARNAM_MATCH_EXACT, 0);
    if (rc != VARNAM_SUCCESS)
    {
        printf("VARNAM_SUCCESS expected. Never got. %s", varnam_get_last_error(handle));
        return 1;
...
int create_possibility_match_duplicates()
{
    ...
    rc = varnam_create_token(handle, "pattern", "value1", "value2", "", "value3", VARNAM_TOKEN_VOWEL, VARNAM_MATCH_POSSIBILITY, 0);
    if (rc != VARNAM_SUCCESS)
    {
        printf("VARNAM_SUCCESS expected. Never got. %s", varnam_get_last_error(handle));
        return 1;
    ...
    rc = varnam_create_token(handle, "pattern ", "value11", "value22", "", "value3", VARNAM_TOKEN_VOWEL, VARNAM_MATCH_POSSIBILITY, 0);
    if (rc != VARNAM_SUCCESS)
    {
...
int only_valid_matchtypes()
{
    ...
    rc = varnam_create_token(handle, "pattern", "value1", "value2", "", "value3", VARNAM_TOKEN_VOWEL, 10, 0);
    if (rc != VARNAM_ERROR)
    {
