...
void resolve_arguments(int argc, char **argv, int *selective, int *fork, char **stests, int *test_arg_start)
{
    char *ptr;
    int i;
...
int main(int argc, char **argv)
{
    ...
    if (argc > 1)
        resolve_arguments(argc, argv, &selective, &fork, stests, &test_arg_start);
